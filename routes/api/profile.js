...
router.get("/me", auth, async (req, res) => {
  try {
    ...
    //req.user.id is coimg from auth middleware
...
router.get("/user/:user_id", checkObjectId("user_id"), async (req, res) => {
  try {
    ...
    const profile = await Profile.findOne({ user: req.params.user_id }) //user_id from url
...
router.put(
  ...
  async (req, res) => {
    ...
    try {
      ...
      //push experience to top in experience array
...
router.put(
  ...
  async (req, res) => {
    ...
    try {
      ...
      profile.education.unshift(req.body); //unshift- add value to top
